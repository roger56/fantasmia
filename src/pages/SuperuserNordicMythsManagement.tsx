...
const SuperuserNordicMythsManagement = () => {
  ...
  useEffect(() => {
    const mockStories: NordicStory[] = [
      {
        id: '1',
        title: 'Thor e il Martello Perduto',
        content: 'La storia di Thor che cerca di recuperare il suo martello magico Mjolnir...',
        hasImage: true,
        language: 'it',
      ...
      {
        id: '2',
        title: 'Odin e i Corvi',
        content: 'Odin, il padre di tutti, aveva due corvi saggi chiamati Huginn e Muninn...',
        hasImage: false,
        language: 'it',
  ...
  const handleReadStory = (story: NordicStory) => {
  ...
  const handleToggleLanguage = (story: NordicStory) => {
  ...
  const handleEditStory = (story: NordicStory) => {
  ...
  const handleShowBooks = (story: NordicStory) => {
    setSelectedStory(story);
    setShowBooks(true);
  };

  const handleShowPoetry = (story: NordicStory) => {
    setSelectedStory(story);
    setShowPoetry(true);
  };

  const handleViewStory = (story: NordicStory) => {
    // Navigate to story viewer
    navigate(`/nordic-story-viewer/${story.id}`);
  };

  const handleAddNewStory = () => {
    // Navigate to story creation form
    navigate('/create-nordic-story');
  };

  return (
    <StoryLayout
      title="I Miti del Nord"
      subtitle="Gestione delle storie sui miti nordici"
...
export default SuperuserNordicMythsManagement;