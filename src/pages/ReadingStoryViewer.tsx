...
const ReadingStoryViewer = () => {
  ...
  return (
    <StoryLayout
      title="Visualizza Storia di Lettura"
      subtitle={`Storia ID: ${id}`}
      onBack={() => navigate('/reading-stories')}
    >
      <div className="space-y-6">
        <div className="bg-white rounded-lg shadow-md p-6">
          <h2 className="text-xl font-semibold mb-4">Storia di Lettura</h2>
          <p className="text-gray-600">
            Contenuto della storia di lettura con ID: {id}
          </p>
          <div className="mt-4 p-4 bg-gray-50 rounded">
            <p>Qui verrà visualizzato il contenuto della storia di lettura...</p>
          </div>
        </div>
      </div>
    </StoryLayout>
