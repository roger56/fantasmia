  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "La storia scientifica è stata salvata con successo"
      });
      ...
      toast({
        title: "Errore",
        description: "Errore nel salvataggio della storia",
        variant: "destructive"
      });
    } finally {
      setIsSaving(false);
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Textarea
                  ...
                  placeholder="Scrivi il contenuto della storia scientifica..."
                  rows={10}
                  className="w-full"
                />
              </div>
