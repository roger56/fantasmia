...
serve(async (req) => {
  ...
  try {
    ...
    const createStylePrompt = (content: string, artStyle: string) => {
      const safeTemplates = {
        'fumetto': `Create a family-friendly cartoon illustration showing: ${content}. Use bright cheerful colors, cartoon style, clear outlines. ABSOLUTELY NO TEXT, NO WRITING, NO LETTERS, NO WORDS, NO SYMBOLS, NO NUMBERS, NO CAPTIONS, NO SPEECH BUBBLES visible anywhere in the image. Completely text-free illustration only. Pure visual storytelling without any readable content whatsoever.`,
        'fotografico': `Create a beautiful realistic image of: ${content}. Professional photography style, good lighting, peaceful scene. ABSOLUTELY NO TEXT, NO WRITING, NO LETTERS, NO WORDS, NO SYMBOLS, NO NUMBERS, NO CAPTIONS visible anywhere in the image. Completely text-free photography only. Family-friendly visual content without any readable content whatsoever.`,
        'astratto': `Create an abstract artistic interpretation of: ${content}. Use colors, shapes and artistic elements to represent the theme. ABSOLUTELY NO TEXT, NO WRITING, NO LETTERS, NO WORDS, NO SYMBOLS, NO NUMBERS, NO CAPTIONS visible anywhere in the image. Completely text-free abstract art only. Creative and peaceful visual art without any readable content whatsoever.`,
        'manga': `Create a manga-style illustration of: ${content}. Japanese anime art style, dynamic poses, expressive characters. ABSOLUTELY NO TEXT, NO WRITING, NO LETTERS, NO WORDS, NO SYMBOLS, NO NUMBERS, NO CAPTIONS, NO SPEECH BUBBLES visible anywhere in the image. Completely text-free manga artwork only. Pure visual storytelling without any readable content whatsoever.`,
        'acquarello': `Create a watercolor painting of: ${content}. Soft watercolor technique, flowing colors, artistic brushstrokes. ABSOLUTELY NO TEXT, NO WRITING, NO LETTERS, NO WORDS, NO SYMBOLS, NO NUMBERS, NO CAPTIONS visible anywhere in the image. Completely text-free watercolor artwork only. Pure visual art without any readable content whatsoever.`,
        'carboncino': `Create a charcoal drawing of: ${content}. Black and white charcoal sketch style, artistic shading, classic drawing technique. ABSOLUTELY NO TEXT, NO WRITING, NO LETTERS, NO WORDS, NO SYMBOLS, NO NUMBERS, NO CAPTIONS visible anywhere in the image. Completely text-free charcoal artwork only. Pure visual art without any readable content whatsoever.`
      }
      return safeTemplates[artStyle] || `Create a beautiful, family-friendly illustration of: ${content}. ABSOLUTELY NO TEXT, NO WRITING, NO LETTERS, NO WORDS, NO SYMBOLS, NO NUMBERS, NO CAPTIONS visible anywhere in the image. Completely text-free image only.`
    }
