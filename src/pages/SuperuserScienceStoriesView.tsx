...
const SuperuserScienceStoriesView = () => {
  ...
  const [selectedStory, setSelectedStory] = useState<ScienceStory | null>(null);
  ...
  const loadStories = () => {
    ...
    if (scienceStories.length > 0) {
      setSelectedStory(scienceStories[0]);
    }
  };
  ...
  const confirmDelete = () => {
    if (deleteScienceStory(storyToDelete)) {
      toast({
        title: "Successo",
  ...
  const handleViewStory = (storyId: string, e: React.MouseEvent) => {
    e.stopPropagation();
    navigate(`/superuser-science-story-viewer/${storyId}`);
  };
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  ...
                  Storie Scientifiche ({stories.length})
                </CardTitle>
              </CardHeader>
              <CardContent>
                {stories.length === 0 ? (
                  <div className="text-center text-slate-600 py-8">
                    ...
                    <p>Nessuna storia scientifica creata ancora.</p>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Sei sicuro di voler eliminare questa storia scientifica? Questa azione non può essere annullata.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
